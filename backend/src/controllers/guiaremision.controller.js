...
const getGuias = async (req, res) => {
    ...
    try {
        ...
        // Obtener el número total de guias
        const [totalResult] = await connection.query(
            "SELECT COUNT(*) as total FROM guia_remision"
        );
...
//Añadir una nueva guía de remisión
//Listar todo de ubigeo
//Listar todo de transportista y de transporte
