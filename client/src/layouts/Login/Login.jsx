      ...
      <div className={`flex items-center justify-center w-full md:w-1/2 p-6 transition-opacity duration-500 ${loaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="w-full max-w-md flex flex-col items-center justify-center">
          <Tabs
            ...
            className="mb-6"
            classNames={{
              tabList: "bg-white/80 dark:bg-zinc-900/80 rounded-xl shadow border border-blue-100/30 dark:border-zinc-700/30 px-2 py-1 flex gap-2 justify-center",
              tab: "px-6 py-2 text-base font-semibold rounded-lg transition-colors",
              tabContent: "py-0"
            }}
          >
            <Tab key="login" title="Iniciar sesión">
              <Card className="w-full max-w-md" style={{ boxShadow: '0 10px 20px hsl(0,0%,.15), 20 15px 10px hsl(0,0%,.10)' }}>
