...
useEffect(() => {
  ...
  return () => { cancelled = true; };
    ...
    const handleAlmacenChange = (event) => {
            ...
            <div class="flex justify-between items-center mb-3">
                <div class='flex'>
                    ...
                    <div class="text-start ml-8">
                        <h1 class="text-xl font-extrabold leading-snug text-blue-800">${empresaData.nombreComercial || ''}</h1>
                        <p class="font-semibold leading-snug text-gray-700">${empresaData.razonSocial || ''}</p>
                        <p class="leading-snug text-gray-600"><span class="font-bold text-gray-800">Central:</span> ${empresaData.direccion || ''}</p>
                        <p class="leading-snug text-gray-600">${empresaData.distrito || ''} - ${empresaData.provincia || ''} - ${empresaData.departamento || ''}</p>
                        <p class="leading-snug text-gray-600"><span class="font-bold text-gray-800">TELF:</span> ${empresaData.telefono || ''}</p>
                        <p class="leading-snug text-gray-600"><span class="font-bold text-gray-800">EMAIL:</span> ${empresaData.email || ''}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div class="space-y-2">
                        <p class="text-sm font-semibold text-gray-800">
                            <span class="font-bold text-gray-900">KARDEX MOVIMIENTOS</span>
                        </p>
                        <p class="text-sm font-semibold text-gray-800">
                            <span class="font-bold text-gray-900">RUC:</span> <span class="font-semibold text-gray-600">${empresaData.ruc || ''}</span>
                        </p>
                        <p class="text-sm font-semibold text-gray-800">
        ...
        await exportHtmlToPdf(htmlContent, `kardex_movimientos.pdf`, options);
    };
