...
function HistoricoTabla() {
  const transactions = [
    { date: '09/06/2024', document: '68 / 400-0006245', name: 'CLIENTE VARIOS', entry: 1, sale: 1, stock: 108, price: 30, cpu: 0, total: 0, note: 'VENTA DE PRODUCTOS' },
    { date: '09/06/2024', document: '68 / 400-0006246', name: 'CLIENTE VARIOS', entry: 1, sale: 1, stock: 107, price: 30, cpu: 0, total: 0, note: 'VENTA DE PRODUCTOS' },
    { date: '09/06/2024', document: '68 / 400-0006247', name: 'CLIENTE VARIOS', entry: 1, sale: 1, stock: 106, price: 30, cpu: 0, total: 0, note: 'VENTA DE PRODUCTOS' },
      ...
      <table className="table w-full">
        <thead>
          <tr>
            ...
            <th className="w-1/12 text-center text-sm font-semibold text-gray-500 uppercase tracking-wider">Mon</th>
            <th className="w-1/12 text-center text-sm font-semibold text-gray-500 uppercase tracking-wider">Precio</th>
            <th className="w-1/12 text-center text-sm font-semibold text-gray-500 uppercase tracking-wider">C.P.U.</th>
...
function HistoricoFilas({ transaction }) {
  return (
    <tr>
      ...
      <td className="text-center py-2 px-4">{transaction.cpu}</td>
      <td className="text-center py-2 px-4">{transaction.total}</td>
