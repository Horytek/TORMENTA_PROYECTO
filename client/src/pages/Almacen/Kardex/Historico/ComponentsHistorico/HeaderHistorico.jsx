...
function HeaderHistorico({ productoData, onDateChange, transactions, previousTransactions, dateRange }) {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-4 bg-white rounded-lg shadow mb-4">
      <div className="flex-1">
        <p className="font-bold text-blue-800">TORMENTA JEANS - 20610968801</p>
