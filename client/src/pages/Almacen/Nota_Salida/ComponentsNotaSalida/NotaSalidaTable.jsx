...
const NotaSalidaTable = forwardRef(({ salidas }, ref)  => {
  ...
  const handleRowClick = (salida) => {
    setDetalleSeleccionado(detalleSeleccionado === salida ? null : salida);
  };
  ...
  return (
    <div className="flex bg-white rounded-lg p-4">
      ...
      <div className="flex-1">
        <Table aria-label="Tabla de salidas">
          <TableHeader>
        ...
        <div className="mt-4 flex justify-between">
          <Pagination
            ...
            color="primary"
            page={currentPage}
            total={Math.ceil(salidas.length / itemsPerPage)}
      ...
      {detalleSeleccionado && (
        <div className="flex-1 ml-4 p-4 border-l border-gray-300">
          <h3 className="font-bold text-lg">Detalles de Salida</h3>
...
export default NotaSalidaTable;