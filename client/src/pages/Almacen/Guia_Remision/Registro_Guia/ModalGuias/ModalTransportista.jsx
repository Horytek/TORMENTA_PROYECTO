            ...
            <div className="modal">
                <div className='content-modal'>
                    ...
                    <div className='modal-body'>
                        ...
                        <div className='w-full text-start mb-5'>
                            <label htmlFor="direc" className='text-sm font-bold text-black'>Dirección:</label>
                            <input type="text" name='direc' className='w-full bg-gray-50 border-gray-300 text-gray-900 rounded-lg border p-1.5' placeholder='Dirección del Transportista' />
                        </div>
                        <div className='w-full text-start mb-5'>
                        ...
                        <div className='w-full text-start mb-5'>
                            ...
                            <input type="text" name='email' className='w-full bg-gray-50 border-gray-300 text-gray-900 rounded-lg border p-1.5' placeholder='Email del Transportista' />
                        </div>
