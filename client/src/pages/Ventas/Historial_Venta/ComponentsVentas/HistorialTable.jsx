  ...
  const renderVentaRow = (venta) => (
    <React.Fragment key={venta.id}>
      <tr onClick={(e) => handleRowClick(e,venta)} className='tr-tabla-venta'>
        ...
        <td className="text-center">{venta.hora_creacion}</td>
        <td className="text-center">
      ...
      <table className="table w-full">
        <thead> 
          <tr>
            ...
            <th className="w-1/8 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">H. EMISIÓN</th>
            <th className="w-1/6 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">F. ANULACIÓN</th>
            <th className="w-1/4 text-start  text-xs font-bold text-gray-500 uppercase tracking-wider">CAJERO</th>
            <th className="w-1/4 text-start  text-xs font-bold text-gray-500 uppercase tracking-wider">U. MODIFICA</th>
