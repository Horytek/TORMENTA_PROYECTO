      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="container-registro-detalle-venta w-full p-4" style={{ height: "max-content" }}>
          ...
          <div className="flex items-center mb-4">
            <input type="text" className={`form-input py-2 px-4 w-full text-gray-700 placeholder-gray-400 rounded focus:outline-none ${!detalleMode ? 'cursor-not-allowed bg-gray-200' : ''}`}
