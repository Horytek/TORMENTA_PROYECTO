...
export const InvitationModal = ({ setIsOpen }) => (
  <AnimatePresence>
    ...
    >
      <div
        className="w-full h-full bg-bg-dark-transparent-darker fixed top-0 left-0 flex z-50 justify-center items-center"
        onClick={() => setIsOpen(false)}
      >
        <div
          className="w-full h-screen sm:h-auto sm:w-3/4 md:w-3/5 lg:w-[1000px] xl:w-[1100px] sm:rounded-2xl bg-bg-dark-transparent-lighter main-border-gray-darker py-12 px-8 sm:px-16 backdrop-blur-xl fixed sm:mb-8 mx-auto z-50"
            ...
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="w-full sm:w-4/5 p-2 mt-4 mx-auto">
                  <button
                    className="py-4 px-6 w-full text-primary-text font-semibold rounded-xl shadow-4xl focus:ring focus:ring-indigo-300 bg-primary-color hover:bg-[#7274f3] transition ease-in-out duration-200"
                    type="button"
                    aria-label="Join now"
                  >
                    Join Now
