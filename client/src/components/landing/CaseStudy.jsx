        ...
        <section className="py-24 bg-[#02040a] text-white relative overflow-hidden">
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                >
                    ...
                    <div className="space-y-12">
                        <div>
                            ...
                            <h3 className="text-4xl lg:text-5xl font-bold font-manrope leading-tight text-balance text-white">
                                Arquitectura diseñada para velocidad y escala.
                            </h3>
                    ...
                    {/* Architecture Graphic Column */}
                    <div className="relative p-8 rounded-3xl bg-gradient-to-br from-[#1a1f2e] to-[#0f121a] border border-white/5 overflow-hidden min-h-[400px] flex flex-col justify-center">
                        {/* Background Grid */}
                        <div className="absolute inset-0 opacity-[0.05]"
                            style={{ backgroundImage: 'linear-gradient(#fff 1px, transparent 1px), linear-gradient(90deg, #fff 1px, transparent 1px)', backgroundSize: '20px 20px' }}
                        />

                        {/* Abstract Representation of "System Info" */}
                        <div className="relative z-10 space-y-6">
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5 backdrop-blur-md">
                                ...
                                <div>
                                    <div className="text-white font-semibold">Base de Datos Distribuida</div>
                                    <div className="text-xs text-gray-500">Node.js + MySQL Cluster</div>
                                </div>
                                <div className="ml-auto text-xs font-mono text-emerald-400">ACTIVE</div>
                            </div>

                            <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5 backdrop-blur-md translate-x-4 border-l-4 border-l-landing-accent">
                                <div className="p-3 rounded-lg bg-landing-accent/10 text-landing-accent">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v4" /><path d="m16.2 7.8 2.9-2.9" /><path d="M18 12h4" /><path d="m16.2 16.2 2.9 2.9" /><path d="M12 18v4" /><path d="m4.9 19.1 2.9-2.9" /><path d="M2 12h4" /><path d="m4.9 4.9 2.9 2.9" /></svg>
                                </div>
                                <div>
                                    <div className="text-white font-semibold">Motor de Sincronización</div>
                                    <div className="text-xs text-gray-500">WebSockets (Socket.io)</div>
                                </div>
                                <div className="ml-auto text-xs font-mono text-landing-accent">LIVE</div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-white/5 backdrop-blur-md">
                                ...
                                <div>
                                    <div className="text-white font-semibold">Interfaz Reactiva</div>
                                    <div className="text-xs text-gray-500">React + Vite + Framer Motion</div>
                                </div>
                                <div className="ml-auto text-xs font-mono text-emerald-400">OPTIMIZED</div>
                            </div>
                        </div>

                        {/* Glow */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-landing-accent/20 blur-[60px] rounded-full pointer-events-none" />
                    </div>
                </motion.div>
            </div>
        </section>
