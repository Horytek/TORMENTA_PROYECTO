  ...
  return (
    <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center">
        ...
        >
          Innovando para el <br className="hidden md:block" />
        ...
        >
          Somos un equipo de ingenieros, diseñadores y estrategas obsesionados con
          simplificar la complejidad tecnológica para las empresas del Perú.
        </motion.p>

      </div>

      {/* Scroll Indicator - Moved to Section Level & Lowered */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <span className="text-xs text-white/30 uppercase tracking-widest font-medium">Conoce más</span>
