      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 py-24">
        ...
        >
          ...
          >
            ...
            <span className="text-secondary-color font-semibold text-sm">Únete al Equipo</span>
          </motion.div>
          ...
          >
            Únete al equipo Horycore y forma parte del{" "}
            <span className="text-white font-semibold">futuro de la gestión empresarial</span>.
          </motion.p>
