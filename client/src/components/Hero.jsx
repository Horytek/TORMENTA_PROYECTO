        ...
        >
          <div className="flex flex-col gap-2 sm:flex-row mt-14 mb-24 sm:mb-40 justify-center">
            ...
            <a
              ...
              className="w-64 sm:w-52 h-12 rounded-xl font-bold text-primary-text border border-solid flex justify-center items-center cursor-pointer bg-bgDark2 hover:bg-bgDark3 border-primaryColor transition text-center no-underline"
