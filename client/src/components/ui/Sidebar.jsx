            ...
            >
                <div
                    className={cn(
                        ...
                        "bg-white dark:bg-zinc-900 shadow-xl border-r border-slate-200 dark:border-zinc-800",
                        className
                    )}
                    style={{
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className={cn(
                            "flex h-full w-full flex-col bg-white dark:bg-zinc-900",
...
const sidebarMenuButtonVariants = cva(
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-white focus-visible:ring-2 active:bg-slate-100 dark:active:bg-zinc-800 active:text-slate-900 dark:active:text-white disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-white dark:data-[active=true]:bg-zinc-800 data-[active=true]:shadow-sm data-[active=true]:font-medium data-[active=true]:text-slate-900 dark:data-[active=true]:text-white data-[active=true]:border data-[active=true]:border-slate-200 dark:data-[active=true]:border-zinc-700 data-[state=open]:hover:bg-slate-100 dark:data-[state=open]:hover:bg-zinc-800 data-[state=open]:hover:text-slate-900 dark:data-[state=open]:hover:text-white group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
    {
        variants: {
            variant: {
                default: "hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-white",
                outline:
                    "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-slate-100 dark:hover:bg-zinc-800 hover:text-slate-900 dark:hover:text-white hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
            },
            size: {
                default: "h-9 text-sm",
                sm: "h-7 text-xs",
