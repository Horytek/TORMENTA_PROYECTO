...
import { buyerCancelarSolicitud, buyerListSolicitudes } from "../api/erpStore";
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                ...
                {(s.estado === "expirada" || s.estado === "rechazada" || (s.estado === "aprobada" && !vigente)) && (
                  <Button size="sm" variant="outline" asChild>
                    <Link to={`/s/${slug}/producto/${s.id_producto}`}>Solicitar nuevamente</Link>
                  </Button>
                )}
              </div>
            </div>
