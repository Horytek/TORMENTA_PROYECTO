...
import { buyerGetPedido, getReviewEligibilidad } from "../api/erpStore";
...
export default function StoreOrderDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link to={`/s/${slug}/cuenta/pedidos`} className="text-sm store-muted hover:underline">
        ← Mis pedidos
      </Link>
      ...
      {listo && (
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 space-y-4">
          ...
          <Button asChild className="w-full min-h-14 text-base">
            <Link to={`/s/${slug}/cuenta/pedidos/${id_orden}/qr`}>
