  ...
  return (
    <div className="mt-2 border store-hairline rounded-[var(--store-radius-lg)] p-4 bg-[var(--vitrina-elevated)]">
      <h3 className="font-semibold text-sm mb-1">
        {modeSolicitud ? "¿En qué sucursal confirmamos el stock?" : "Stock y recojo por sucursal"}
      </h3>
      <p className="text-xs store-muted mb-4">
        {modeSolicitud
          ...
          : "El inventario es el del ERP. Si hay unidades, puedes comprar. Elige la sucursal de recojo."}
      </p>
