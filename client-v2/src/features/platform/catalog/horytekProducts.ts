...
export const HORYTEK_PRODUCTS: HorytekProduct[] = [
  ...
  },
  {
    ...
    slug: "tienda-web",
    name: "Tienda web",
    job: "Ecommerce propio del ERP con checkout MercadoPago y ventas en Reportes",
    database: "",
    isolation: "id_tenant",
    ...
    pitch: "Vitrina pública con stock del ERP, carrito, MercadoPago y WhatsApp solo como consulta.",
  },
  {
    id: "sync",
    slug: "sync-stock",
...
const LOGIN_MODE_META: Record<string, { label: string; description: string; priority: number }> = {
  ...
  sync: { label: "Sync Stock", description: "Reconciliación omnicanal", priority: 11 },
  taller: { label: "Taller", description: "Órdenes de planta y PIN operario", priority: 12 },
  preventa: { label: "Preventa", description: "Campañas y reservas", priority: 13 },
  crm: { label: "CRM", description: "Pipeline comercial", priority: 14 },
  envios: { label: "Envíos", description: "Guías y tracking público", priority: 15 },
  wms: { label: "WMS", description: "Almacén y tareas de operario", priority: 16 },
  despacho: { label: "Despacho", description: "Rutas y app chofer", priority: 17 },
