...
const ROTULOS_EXTERIORES = [
  ...
  { id: "ro-c", d: arco(R_TEXTO, 186, 258, 0), texto: "Punto de venta" },
  { id: "ro-d", d: arco(R_TEXTO, 102, 174, 0), texto: "Tienda online" },
];

const ROTULOS_INTERIORES = [
  { id: "ri-a", d: arco(R_PUNTEADO, -52, 52, 1), texto: "Reportes y margen" },
  { id: "ri-b", d: arco(R_PUNTEADO, 128, 232, 0), texto: "Compras y proveedores" },
];
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center">
          <p className="text-[22px] font-bold tracking-[-0.03em] text-foreground">
